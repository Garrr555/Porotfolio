      ...
      <div className="container">
        <div className="flex flex-wrap ">
          <div className="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/3">
            <h2 className="font-bold text-4xl text-white mb-5">ITTP</h2>
            <h3 className="font-bold text-2xl mb-2">Hubungi Saya</h3>
            <p>mohammadtegaribrahim@gmail.com</p>
            <p>
              Jl. DI Panjaitan No.128, Karangreja, Purwokerto Kidul, Kec.
              Purwokerto Sel., Kabupaten Banyumas,
            </p>
            <p>Purwokerto</p>
          </div>
        ...
        <div className="w-full pt-10 border-t border-slate-700">
          ...
          <p className="font-medium text-xs text-slate-500 text-center">
            ...
            <a
              ...
              target="_blank "
              className="font-bold text-[#61dbfb] mx-1"
            >
              React
            </a>
            &
            <a
              ...
              target="_blank "
              className="font-bold text-sky-500 ml-1"
            >
              Tailwind
            </a>
            .
